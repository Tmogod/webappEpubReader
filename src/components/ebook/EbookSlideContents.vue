  ...
  <div class="ebook-slide-contents">
    ...
    <scroll class="slide-contents-list"
      ...
      <div class="slide-contents-item" v-for="(item, index) in navigation" :key="index">
        ...
        <span class="slide-contents-item-label" :class="{'selected': section === index}" :style="contentItemStyle(item)" @click="display(item.href)">{{item.label}}</span>
...
export default {
  ...
  methods: {
    ...
    displaySearch (target, hightlight = false) {
      this.display(target, () => {
