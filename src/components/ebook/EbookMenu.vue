  ...
  <transition name="slide-up">
    <div class="menu-wrapper" :class="{'hide-box-shadow': !menuVisible || settingVisible >= 0}" v-show="menuVisible">
      <div class="icon-wrapper">
        <span class="icon-menu" @click="showSettingMenu(3)"></span>
      </div>
      <div class="icon-wrapper">
        <span class="icon-progress" @click="showSettingProgress(2)"></span>
      </div>
      <div class="icon-wrapper">
        <span class="icon-bright" @click="showSettingBright(1)"></span>
      </div>
      <div class="icon-wrapper">
        <span class="icon-A" @click="showSettingA(0)"></span>
      </div>
    </div>
  </transition>
...
export default {
  ...
  methods: {
    ...
    showSettingProgress (key) {
      if (this.settingVisible === 2) {
        this.setSettingVisible(-1)
      } else {
        this.setSettingVisible(key)
      }
