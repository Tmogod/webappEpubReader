  ...
  methods: {
    ...
    initGlobalStyle () {
      switch (this.defaultTheme) {
        case 'Default':
          addCss('http://1.116.178.71/theme/theme_default.css')
          break
        case 'Eye':
          addCss('http://1.116.178.71/theme/theme_eye.css')
          break
        case 'Gold':
          addCss('http://1.116.178.71/theme/theme_gold.css')
          break
        case 'Night':
          addCss('http://1.116.178.71/theme/theme_night.css')
          break
        default:
          addCss('http://1.116.178.71/theme/theme_default.css')
          break
